...
2. **`TSPOptimized`**: Implement a significantly faster algorithm. You can choose to write an exact solver using **Held-Karp Bitmask DP**, or an approximation/heuristic like **Nearest Neighbor** or **2-opt**.
...
Run your executable twice (once using the Brute Force class, once using the Optimized class) and direct the outputs to different JSON files.
